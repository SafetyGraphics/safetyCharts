...
#'
#' @param data QT data structured as one record per person per visit per measurement. See details for column requirements.
...
init_QTsafetyOutlierExplorer <- function(data, settings) {
