...
#' 
#' The default mapping - designed to work with the CDSISC AdAM format - like safetyata::adam_adlbc - is:   
#' 
#' ```
#' mapping <- list(
#'            measure_col = "PARAM", 
...
#' 
#' For more options see the [full specs](https://github.com/SafetyGraphics/hep-explorer/wiki/Configuration) for the javascript library.
#' 
#' @examples 
#' 
